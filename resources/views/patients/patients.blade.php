            ...
            @if (Auth::user())
                <div class="shadow-lg rounded-lg overflow-hidden container mx-auto">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div><canvas class="p-10" id="chartBar2" style="width:100%;height:300px;"></canvas></div>
                        <div><canvas class="p-10" id="chartBar3" style="width:100%;height:300px;"></canvas></div>
                    </div>
                        ...
                        <div class="overflow-hidden sm:rounded-lg shadow-md p-5">
                            <table id="patients-table">
                                <thead class="bg-gray-200 dark:bg-gray-700">
                                    <tr>
                                        <th scope="col"
                                            class="text-xs font-bold font-medium text-gray-700 px-6 py-3 text-left uppercase tracking-wider dark:text-gray-400">
                                            Patient ID
                                        </th>
                                        <th scope="col"
                                            class="text-xs font-bold font-medium text-gray-700 px-6 py-3 text-left uppercase tracking-wider dark:text-gray-400">
