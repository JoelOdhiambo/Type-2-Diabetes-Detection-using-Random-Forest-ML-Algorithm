...
<div id="create-modal" aria-hidden="true"
    ...
    <div class="relative w-full max-w-lg px-4 h-full md:h-auto">
        ...
        <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
            ...
            <form id='edit-patient' class="space-y-6 px-2 lg:px-1 pb-1 sm:pb-1 xl:pb-1" action="/patients" method="post"
                    ...
                    <div class="border-t border-gray-200 ">
                        <dl>
                            ...
                            <div class="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    <input type="number" step="any" name="pedegree" id="pedegree"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                        placeholder="Diabetes Pedegree Function..." required>
                            ...
                            <div
                                ...
                                <button data-modal-toggle="create-modal" type="submit"
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
