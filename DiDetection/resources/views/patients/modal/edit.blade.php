<div id="edit-modal" aria-hidden="true" class="hidden overflow-x-hidden overflow-y-auto fixed top-20 left-0 right-0 md:inset-0 z-50 justify-center items-center h-modal sm:h-full">
                                            <div class="relative w-full max-w-lg px-4 h-full md:h-auto">
                                                ...
                                                <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                                                    ...
                                                    <form id="edit-patient"class="space-y-6 px-2 lg:px-1 pb-1 sm:pb-1 xl:pb-1" action="/patients/{{$patient->id}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                            ...
                                                            <div class="border-t border-gray-200 ">
                                                                <dl>
                                                                    ...
                                                                    <div class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                                        ...
                                                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                                            <input type="number" name="glucose" id="glucose" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="{{$patient->glucose}}" value="{{$patient->glucose}}" required>
                                                                    ...
                                                                    <div class="bg-white px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                                        <dt class="text-sm font-medium text-gray-500">
                                                                            Insulin
                                                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                                            <input type="number" name="insulin" id="insulin" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="{{$patient->insulin}}" value="{{$patient->insulin}}" required>
                                                                    ...
                                                                    <div class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                                        ...
                                                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                                            <input type="number" name="bmi" id="bmi" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="{{$patient->bmi}}" value="{{$patient->bmi}}" required>
                                                                    ...
                                                                    <div class="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                                        ...
                                                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                                            <input type="number" name="age" id="age" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="{{$patient->age}}" value="{{$patient->age}}" required>
