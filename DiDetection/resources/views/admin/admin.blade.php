            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-600">
                    <form action="{{route('admin.assign')}}" method="post">
                        ...
                        {{csrf_field()}}
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 dark:text-white"><button type="submit" class="flex items-center bg-green-500 text-white px-2 py-1 text-xs font-semibold  uppercase transition-colors duration-200 transform bg-white rounded hover:bg-green-700  focus:bg-gray-400 focus:outline-none button">Assign Roles</button></td>
                    </form>
                </tr>
                @endforeach
            </tbody>
